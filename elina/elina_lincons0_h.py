...
class ElinaConstyp(CtypesEnum):
    """
    Enum compatible with elina_linconstyp_t from elina.eline_lincons0.h.
...
class ElinaLincons0(Structure):
    """
    ElinaLincons0 ctype compatible with elina_lincons0_t from elina.eline_lincons0.h.
...
class ElinaLincons0Array(Structure):
    """
    ElinaLinconsArray0 ctype compatible with elina_lincons0_array_t from elina.eline_lincons0.h.
