...
from elina.elina_lincons0_h import *
...
class ElinaTcons0(Structure):
    """
    ElinaTcons0 ctype compatible with elina_tcons0_t from elina.eline_tcons0.h.
...
class ElinaTcons0Array(Structure):
    """
    ElinaTcons0Array ctype compatible with elina_tcons0_array from elina.eline_tcons_array.h.
