from elina.elina_dimension_h import *
...
class ElinaLinexprDiscr(CtypesEnum):
    """
    Enum compatible with discr field in elina_linexpr0_t from elina.eline_linexpr0.h.
...
class ElinaLinterm(Structure):
    """
    ElinaLinterm ctype compatible with elina_linterm_t from elina.eline_linexpr0.h.
...
class ElinaLinexprUnion(Union):
    """
    Ctype representing the union field in elina_linexpr0_t from from elina.eline_linexpr0.h.
...
class ElinaLinexpr0(Structure):
    """
    ElinaLinexpr0 ctype compatible with elina_linexpr0_t from elina.eline_linexpr0.h.
...
class ElinaLinexprType(CtypesEnum):
    """
    Enum compatible with elina_linexpr_type_t from elina.eline_linexpr0.h.
...
class ElinaCoefftag(CtypesEnum):
    """
    Enum compatible with elina_coefftag_t from elina.eline_linexpr0.h.
