from elina.elina_interval_h import *
...
class ElinaCoeffDiscr(CtypesEnum):
    """ Enum compatible with discr field in elina_coeff_t from elina.eline_coeff.h """
...
class ElinaCoeffUnion(Union):
    """ Ctype representing the union field in elina_coeff_t from elina.eline_coeff.h """

    _fields_ = [('scalar', ElinaScalarPtr), ('interval', ElinaIntervalPtr)]


class ElinaCoeff(Structure):
    """ ElinaCoeff ctype compatible with elina_coeff_t from elina.eline_coeff.h """
