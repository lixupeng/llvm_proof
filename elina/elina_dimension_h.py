...
class ElinaDimension(Structure):
    """
    ElinaDimension ctype compatible with elina_dimension_t from elina.eline_dimension.h.
...
class ElinaDimchange(Structure):
    """
    ElinaDimchange ctype compatible with elina_dimchange_t from elina.eline_dimension.h.
...
class ElinaDimchange2(Structure):
    """
    ElinaDimchange2 ctype compatible with elina_dimchange2_t from elina.eline_dimension.h.
...
class ElinaDimperm(Structure):
    """
    ElinaDimperm ctype compatible with elina_dimperm_t from elina.eline_dimension.h.
