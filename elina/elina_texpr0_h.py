...
from elina.elina_linexpr0_h import *
...
class ElinaTexprOp(CtypesEnum):
    """
    Enum compatible with elina_texpr_op_t from elina.eline_texpr0.h.
...
class ElinaTexprRtype(CtypesEnum):
    """
    Enum compatible with elina_texpr_rtype_t from elina.eline_texpr0.h.
...
class ElinaTexprRdir(CtypesEnum):
    """
    Enum compatible with elina_texpr_rdir_t from elina.eline_texpr0.h.
    Rounding direction.
...
class ElinaTexpr0Node(Structure):
    """
    ElinaTexpr0Node ctype compatible with elina_texpxr0_node_t from elina.eline_texpr0.h.
...
class ElinaTexprDiscr(CtypesEnum):
    """
    Enum compatible with elina_texpr_discr_t from elina.eline_texpr0.h.
...
class ElinaTexpr0Union(Structure):
    """
    ElinaTexpr0Union ctype compatible with the union in elina_texpr0_t from elina.eline_texpr0.h.
...
class ElinaTexpr0(Structure):
    """
    ElinaTexpr0 ctype compatible with elina_texpr0_t from elina.eline_texpr0.h.
