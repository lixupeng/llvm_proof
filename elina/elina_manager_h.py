...
from elina.elina_coeff_h import *
...
class ElinaMembuf(Structure):
    """
    ElinaMembuf ctype compatible with elina_membuf_t from elina.eline_manager.h.
...
class ElinaFunID(CtypesEnum):
    """
    Enum compatible with elina_funid_t from elina.eline_manager.h.
...
class ElinaExcLog(Structure):
    """
    ElinaExcLog ctype compatible with elina_exclog_t from elina.eline_manager.h.
...
class ElinaResult(Structure):
    """
    ElinaResult ctype compatible with elina_result_t from elina.eline_manager.h.
...
class ElinaFunOpt(Structure):
    """
    ElinaFunOpt ctype compatible with elina_funopt_t from elina.eline_manager.h.
...
class ElinaOption(Structure):
    """
    ElinaOption ctype compatible with elina_option_t from elina.eline_manager.h
...
class ElinaManager(Structure):
    """
    ElinaManager ctype compatible with elina_manager_t from elina.eline_manager.h
