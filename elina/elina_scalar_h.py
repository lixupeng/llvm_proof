...
class ElinaScalarDiscr(CtypesEnum):
    """ Enum compatible with discr field in elina_scalar_t from elina.eline_scalar.h """
...
class ElinaScalarUnion(Union):
    """ Ctype representing the union field in elina_scalar_t from elina.eline_scalar.h """

    _fields_ = [('dbl', c_double), ('mpq_ptr', POINTER(Mpq)), ('mpfr_ptr', POINTER(Mpfr))]


class ElinaScalar(Structure):
    """ ElinaScalar ctype compatible with elina_scalar_t from elina.eline_scalar.h """
